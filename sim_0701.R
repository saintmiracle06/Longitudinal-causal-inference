...
file_name1 <- paste0(Sys.time(), "est_sdr_200.csv")
file_name2 <- paste0(Sys.time(), "est_ipw_200.csv")
file_name3 <- paste0(Sys.time(), "est_tmle_200.csv")
file_name4 <- paste0(Sys.time(), "est_sub_200.csv")

file_name5 <- paste0(Sys.time(), "sd_sdr_200.csv")
file_name6 <- paste0(Sys.time(), "sd_tmle_200.csv")

file_name7 <- paste0(Sys.time(), "low_sdr_200.csv")
file_name8 <- paste0(Sys.time(), "low_tmle_200.csv")

file_name9 <- paste0(Sys.time(), "high_sdr_200.csv")
file_name10 <- paste0(Sys.time(), "high_tmle_200.csv")


write.csv(est1, file_name1, row.names=FALSE)
write.csv(est2, file_name2, row.names=FALSE)
write.csv(est3, file_name3, row.names=FALSE)
write.csv(est4, file_name4, row.names=FALSE)

write.csv(sd1, file_name5, row.names=FALSE)
write.csv(sd3, file_name6, row.names=FALSE)

write.csv(low1, file_name7, row.names=FALSE)
write.csv(low3, file_name8, row.names=FALSE)

write.csv(high1, file_name9, row.names=FALSE)
write.csv(high3, file_name10, row.names=FALSE)
